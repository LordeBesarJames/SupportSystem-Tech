...
public class responder {
    ...
    private int lastAnswer = -1;  // to keep track of the last answer
    ...
    public String generateResponse(String input) {
        ...
        String[] splitInput = input.split("\\W+");  // split input by non-alphabetic characters
        ...
        lastAnswer = responseIndex;  // update lastAnswer to avoid repetition
